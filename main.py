...
urls = [
    ...
    ## Malicious URL Blocklist (abuse.ch) lepiej w ublock lub osobno dodać całą listę Abuse.ch - ThreatFox IOC database o ile ruter da rade co 5 minut aktualizować (opensense na x86 powinien dać rade) ale dla rutera na amr lepiej niech to robi przeglądarka oraz bardziej aktuale zawierają to listy hagezi tif - test do wywalenia? w skrócie nie wydajne 
    "https://adguardteam.github.io/HostlistsRegistry/assets/filter_11.txt",
    ## Phishing URL Blocklist lepiej w ublock - test do wywalenia?
